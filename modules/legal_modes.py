...
SYS_COMMON = (
    ...
    "반드시 출처는 https://www.law.go.kr/법령/민법/제839조의2 와 같은 형태로 세부조항 링크를 제공해야 한다."
)
...
SYS_MEMO = (
    "출력형식(고정): 1) 사건 요지(2~4문장) 2) 적용 법령/규정(≤5) 3) 핵심 판단(3~6 불릿) "
    "4) 근거 조문 요지(쟁점당 1~2개, 각 1~2문장) 5) 리스크/예외(≤4) 6) 즉시 조치 체크리스트(3~5) "
    "7) 참고 링크(공식 출처만). 동일 내용 반복 금지, 한 번만 출력."
)
SYS_DRAFT = (
